...
<div class="page-wrapper">
    ...
    <aside class="menu-sidebar2">
        <div class="logo">
            <a href="#">
                <img src="{{ asset('tmp/images/icon/logo-white.png') }}" alt="Cool Admin" />
            </a>
        </div>
        <div class="menu-sidebar2__content js-scrollbar1">
            <div class="account2">
                <div class="image img-cir img-120">
                    <img src="{{ asset('tmp/images/icon/avatar-big-01.jpg') }}" alt="John Doe" />
                </div>
    ...
    <div class="page-container2">
                ...
                <div class="container-fluid">
                    <div class="header-wrap2">
                        <div class="logo d-block d-lg-none">
                            <a href="#">
                                <img src="{{ asset('tmp/images/icon/logo-white.png') }}" alt="CoolAdmin" />
                            </a>
                        </div>
        ...
        <aside class="menu-sidebar2 js-right-sidebar d-block d-lg-none">
            <div class="logo">
                <a href="#">
                    <img src="../../public/tmp/images/icon/logo-white.png" alt="Cool Admin" />
                </a>
            </div>
            <div class="menu-sidebar2__content js-scrollbar2">
                <div class="account2">
                    <div class="image img-cir img-120">
                        <img src="../../public/tmp/images/icon/avatar-big-01.jpg" alt="John Doe" />
                    </div>
                    <h4 class="name">john doe</h4>
                    <a href="#">Sign out</a>
                </div>
