                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="table-data-feature">
                                                <a href="{{ url('admin/archive/deleted/rec',$item->id) }}" class="item" data-toggle="tooltip" data-placement="top" title="Восстановить">
                                                    <i class="zmdi zmdi-view-web " style="color:#00b5e9;"></i>
                                                </a>
                                            </div>
                                        </td>
                                    </tr>
