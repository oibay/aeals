                            ...
                            @if($materials->count() > 0)
                                @foreach($materials as $item)
                                    <tr>
                                        ...
                                        <td>{{ $loop->index + 1 }}</td>
                                        <td><a href="{{ url('admin/materials/edit',$item->id) }}">
                                                {{ $item->title }}
                                            </a></td>

                                        <td>{{ $item->created_at }}</td>
                                        <td>
                                            <a href="{{ url('admin/materials/edit',$item->id) }}">
    ...
    <div class="modal fade" id="mediumModal" tabindex="-1" role="dialog" aria-labelledby="mediumModalLabel" aria-hidden="true">
        <div class="modal-dialog modal-lg" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('addPostMaterial') }}" method="post">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input id="name" type="text" class="form-control" name="title" value="" placeholder="Введите название" >
